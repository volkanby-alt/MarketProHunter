...
public sealed class MainForm : Form
{
    ...
    private void ConfigureResultsGrid()
    {
        ...
        _resultsGrid.Columns.Add("fav", "Fav"); _resultsGrid.Columns.Add("uploadScore", "Upload"); _resultsGrid.Columns.Add("uploadDecision", "Decision"); _resultsGrid.Columns.Add("competition", "Comp"); _resultsGrid.Columns.Add("confidence", "Conf %"); _resultsGrid.Columns.Add("overall", "Overall"); _resultsGrid.Columns.Add("rec", "Rec");
